      ...
      <Card className="p-6 border-border" data-testid="analytics-empty">
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground">
            لا توجد بيانات كافية لعرض التحليلات. الرجاء إضافة توافر اللاعبين.
          </p>
        </div>
      </Card>
    );
    ...
    <div className="space-y-4">
      <Card className="p-6 border-border" data-testid="analytics-card">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground">تحليلات التوافر</h3>
            <p className="text-sm text-muted-foreground">
              أفضل أوقات التدريب بناءً على توافر اللاعبين
            </p>
          </div>
        </div>
          ...
          <div className="mb-6 p-4 rounded-lg bg-accent/50 border border-accent-border">
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant="secondary" className="text-xs">
                {mostAvailableDay.count} من {scheduleData.length} لاعبين متاحين
              </Badge>
            </div>
          </div>
        )}
